...
class AsteroidsRepository(private val database: AsteroidsDatabase) {
    val asteroidsNextWeek: LiveData<List<Asteroid>> = database.asteroidDao.getAsteroidsNextWeek().map {
        it.asDomainModel()
    }
    val asteroidsToday: LiveData<List<Asteroid>> = database.asteroidDao.getAsteroidsToday().map {
        it.asDomainModel()
    }
